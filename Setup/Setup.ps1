...
#SV: Commenting this line and repalcing with correct line below
# $encryptedClientSecret = ConvertTo-SecureString ($newAADApp | ConvertFrom-Json).secrets.value -AsPlainText -Force
$encryptedClientSecret = ConvertTo-SecureString ($newAADApp | ConvertFrom-Json).secret -AsPlainText -Force
...
# Upload schedule
# SV: Commenting this line and replacing with correct line below
...
$newSchedule = New-AzAutomationSchedule -AutomationAccountName $automationAccountName -Name $mainRunbook.Name.Replace(".ps1","") -StartTime $StartTime -HourInterval 1 -ResourceGroupName $resourceGroupName -TimeZone "Etc/UTC"
